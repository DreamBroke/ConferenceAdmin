...
<nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="index.html">广西大学会议信息后台管理中心</a>
	</div>
	<!-- /.navbar-header -->
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				<li><a href="#"><i class="fa fa-coffee fa-fw"></i> 会议信息管理<span
						class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a href="#">会议基础信息管理</a></li>
						<li><a href="#">会议日程管理</a></li>
						<li><a href="#">会议周边管理</a></li>
					</ul> <!-- /.nav-second-level --></li>
				<li><a href="#"><i class="fa fa-male fa-fw"></i> 工作人员管理<span
						class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a href="#">工作人员管理</a></li>
						<li><a href="#">工作种类管理</a></li>
						<li><a href="#">工作权限管理</a></li>
					</ul> <!-- /.nav-second-level --></li>
...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">会议基础信息管理</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
